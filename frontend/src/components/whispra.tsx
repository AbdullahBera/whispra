    ...
    <div className="flex flex-col h-screen bg-gray-100 p-4 sm:p-6 lg:p-8">
      <header className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold flex items-center">
          <Mic className="mr-2 h-6 w-6 sm:h-8 sm:w-8 text-blue-600" />
          Whispra
        </h1>
      </header>
      ...
      <div className="flex flex-col lg:flex-row gap-6 flex-grow overflow-hidden">
        ...
        <div className="w-full lg:w-1/3 bg-white rounded-xl shadow-lg shadow-blue-100/50 p-4">
          ...
          <div className="space-y-4">
            ...
            <ScrollArea className="h-[calc(100vh-24rem)] sm:h-[calc(100vh-22rem)] border rounded-md p-2">
              {files.map((file, index) => (
                <div key={index} className="mb-2 flex items-center justify-between rounded-lg border p-2 text-sm">
                  <span className="truncate max-w-[60%] sm:max-w-[70%]">{file.file.name}</span>
